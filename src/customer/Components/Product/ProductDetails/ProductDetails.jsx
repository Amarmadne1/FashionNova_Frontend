...
import SimiliarProductSection from "../../Home/SimliarProductCard";
        ...
        <nav aria-label="Breadcrumb">
          ...
          >
            ...
            <div className="flex items-center">
                ...
                <div className="flex items-center">
                  <a
                    href={`/${customersProduct.product?.category.parentCategory.parentCategory.name}/${customersProduct.product?.category.parentCategory.name}/${customersProduct.product?.category.name}`}
                    className="mr-2 text-sm font-medium text-gray-900"
                  >
